...
label = Label(text= "welcom to the tic-tac game ready!", font=("consolas", 15) ,fg='slate blue')
label.pack(side="top")
label = Label(text= player + " turn", font=("consolas", 40),fg='navy')
label.pack(side="top")

reset_button = Button(text="restart",bg="pink", font=("consolas", 20), command=new_game)
